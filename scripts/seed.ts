...
export const seededExercises: SeedExercise[] = [
  ...
  { id: exUUID('Strict Press'), name: 'Strict Press', movement_pattern: 'push', equipment_required: ['Barbell', 'Weights'], base_difficulty: 5 },
  { id: exUUID('Push Press'), name: 'Push Press', movement_pattern: 'push', equipment_required: ['Barbell', 'Weights'], base_difficulty: 6 },
  { id: exUUID('Push Jerk'), name: 'Push Jerk', movement_pattern: 'push', equipment_required: ['Barbell', 'Weights'], base_difficulty: 7 },
  { id: exUUID('Thruster'), name: 'Thruster', movement_pattern: 'push', equipment_required: ['Barbell', 'Weights'], base_difficulty: 8 },
  ...
  { id: exUUID('Bench Press'), name: 'Bench Press', movement_pattern: 'push', equipment_required: ['Barbell', 'Weights'], base_difficulty: 5 },
  ...
  { id: exUUID('Shoulder to Overhead'), name: 'Shoulder to Overhead', movement_pattern: 'push', equipment_required: ['Barbell', 'Weights'], base_difficulty: 7 },
  ...
  { id: exUUID('Barbell Row'), name: 'Barbell Row', movement_pattern: 'pull', equipment_required: ['Barbell', 'Weights'], base_difficulty: 5 },
  ...
  { id: exUUID('Sumo Deadlift High Pull'), name: 'Sumo Deadlift High Pull', movement_pattern: 'pull', equipment_required: ['Barbell', 'Weights'], base_difficulty: 6 },
  ...
  { id: exUUID('Back Squat'), name: 'Back Squat', movement_pattern: 'squat', equipment_required: ['Barbell', 'Weights'], base_difficulty: 6 },
  { id: exUUID('Front Squat'), name: 'Front Squat', movement_pattern: 'squat', equipment_required: ['Barbell', 'Weights'], base_difficulty: 7 },
  { id: exUUID('Overhead Squat'), name: 'Overhead Squat', movement_pattern: 'squat', equipment_required: ['Barbell', 'Weights'], base_difficulty: 8 },
  ...
  { id: exUUID('Squat Clean'), name: 'Squat Clean', movement_pattern: 'squat', equipment_required: ['Barbell', 'Weights'], base_difficulty: 8 },
  { id: exUUID('Squat Snatch'), name: 'Squat Snatch', movement_pattern: 'squat', equipment_required: ['Barbell', 'Weights'], base_difficulty: 9 },
  { id: exUUID('DB Squat Clean'), name: 'DB Squat Clean', movement_pattern: 'squat', equipment_required: ['Dumbbell'], base_difficulty: 6 },
  { id: exUUID('Overhead Walking Lunge'), name: 'Overhead Walking Lunge', movement_pattern: 'squat', equipment_required: ['Barbell', 'Weights'], base_difficulty: 6 },
  // New squat exercises
  ...
  // ── HINGE movements (15) ─────────────────────────────────────────────────
  { id: exUUID('Deadlift'), name: 'Deadlift', movement_pattern: 'hinge', equipment_required: ['Barbell', 'Weights'], base_difficulty: 6 },
  { id: exUUID('Clean'), name: 'Clean', movement_pattern: 'hinge', equipment_required: ['Barbell', 'Weights'], base_difficulty: 8 },
  { id: exUUID('Power Clean'), name: 'Power Clean', movement_pattern: 'hinge', equipment_required: ['Barbell', 'Weights'], base_difficulty: 7 },
  { id: exUUID('Snatch'), name: 'Snatch', movement_pattern: 'hinge', equipment_required: ['Barbell', 'Weights'], base_difficulty: 9 },
  { id: exUUID('Power Snatch'), name: 'Power Snatch', movement_pattern: 'hinge', equipment_required: ['Barbell', 'Weights'], base_difficulty: 8 },
  ...
  { id: exUUID('Clean and Jerk'), name: 'Clean and Jerk', movement_pattern: 'hinge', equipment_required: ['Barbell', 'Weights'], base_difficulty: 8 },
  { id: exUUID('Hang Power Clean'), name: 'Hang Power Clean', movement_pattern: 'hinge', equipment_required: ['Barbell', 'Weights'], base_difficulty: 7 },
  { id: exUUID('Hang Power Snatch'), name: 'Hang Power Snatch', movement_pattern: 'hinge', equipment_required: ['Barbell', 'Weights'], base_difficulty: 7 },
  ...
  { id: exUUID('Weighted Sit Up'), name: 'Weighted Sit Up', movement_pattern: 'core', equipment_required: ['Weights'], base_difficulty: 3 },

  // ── Additional exercises for equipment coverage ─────────────────────────────
  { id: exUUID('Plate Ground to Overhead'), name: 'Plate Ground to Overhead', movement_pattern: 'push', equipment_required: ['Weights'], base_difficulty: 4 },
  { id: exUUID('Overhead Plate Lunge'), name: 'Overhead Plate Lunge', movement_pattern: 'squat', equipment_required: ['Weights'], base_difficulty: 4 },
